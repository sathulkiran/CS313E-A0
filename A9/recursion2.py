...
#  Description: recursive sorting/summing functions
...
def splitArrayHelper(left_sum, right_sum, idx, nums):
    if (idx >= len(nums)):
        ...
        return splitArrayHelper(left_sum + nums[idx], right_sum, idx + 1, nums) or splitArrayHelper(left_sum, right_sum + nums[idx], idx + 1, nums)
...
def splitOdd10Helper(left_sum, right_sum, idx, nums):
    if (idx >= len(nums)):
        return ((left_sum % 10 == 0) and (right_sum % 2 == 1)) or ((right_sum % 10 == 0) and (left_sum % 2 == 1))
    else:
        return splitOdd10Helper(left_sum + nums[idx], right_sum, idx + 1, nums) or splitOdd10Helper(left_sum, right_sum + nums[idx], idx + 1, nums)
...
def split53Helper(left_sum, right_sum, idx, nums):
    if (idx >= len(nums)):
        return (left_sum == right_sum)
    if (nums[idx] % 5 == 0):
        return split53Helper(left_sum + nums[idx], right_sum, idx + 1, nums)
    elif (nums[idx] % 3 == 0) and (nums[idx] % 5 != 0):
        return split53Helper(left_sum, right_sum + nums[idx], idx + 1, nums)
    else:
        return split53Helper(left_sum + nums[idx], right_sum, idx + 1, nums) or split53Helper(left_sum, right_sum + nums[idx], idx + 1, nums)
